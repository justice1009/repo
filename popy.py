...
if name == '고객 Painpoint 실적':
    ...
    if btn_clicked:
        ...
        def main() :    
            ...
            ds= ds.style.applymap(draw_color_cell,color="#ffccff",subset=pd.IndexSlice[:,[' PPM(22년) ']]).set_precision(2) 
        ...
        def main() :    
            ...
            ds2= ds2.style.applymap(draw_color_cell,color='#fff0f5',subset=pd.IndexSlice[:,[' PPM(21년) ']]).set_precision(2) 
            #색상과 소숫점 적용
